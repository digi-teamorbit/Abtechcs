            ...
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Client</h3>
                        ...
                        <a class="btn btn-success pull-right" href="{{ url('/admin/client/create') }}"><i
                        ...
                        <table class="table color-table table-bordered product-table table-hover dataTable no-footer" role="grid" aria-describedby="myTable_info" id="myTable">
                            ...
                            @foreach($client as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td><td class="text-center"><img src="{{asset($item->image)}}"></td>
                                    <td class="text-center">

                                            <a href="{{ url('/admin/client/' . $item->id) }}"
                                               title="View Client">
