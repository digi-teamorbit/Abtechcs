...
Route::group(['middleware' => ['auth', 'roles'],'roles' => 'admin','prefix'=>'admin'], function () {
    ...
    Route::get('quote/inquiries','Admin\AdminController@quoteSubmissions');
    Route::get('quote/inquiries/{id}','Admin\AdminController@quoteshow');
    ...
    Route::any('quote/submissions/delete/{id}','Admin\AdminController@quoteSubmissionsDelete'); 
...
Route::post('quote-submit','HomeController@quoteSubmit')->name('quoteSubmit');
