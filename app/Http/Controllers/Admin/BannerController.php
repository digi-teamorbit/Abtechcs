    ...
    public function store(Request $request)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','add-'.$model)->first()!= null) {
            ...
            $file = $request->file('video');
                ...
                $resume_path = 'uploads/banner/';
                $fileName = $file->getClientOriginalName();
                $profileImage = date("Ymd").$fileName.".".$file->getClientOriginalExtension();

        $request->video->move(public_path('uploads/banner/'), $profileImage);

        $banner->video = $resume_path.$profileImage;
        ...
        $request->image->move(public_path('uploads/banner/'), $profileImage);

        $banner->image = $resume_path.$profileImage;
    ...
    public function update(Request $request, $id)
    {
       ...
       // VIDEO UPLOAD
        if ($request->hasFile('video')) {
            ...
            $image_path = public_path($banner->video); 
            ...
            $pathToStore = public_path('uploads/banner/');
             ...
             $request->video->move($pathToStore, $fileNameToStore);
        ...
        if ($request->hasFile('image')) {
            ...
            $pathToStore = public_path('uploads/banner/');
             ...
             $request->image->move($pathToStore, $fileNameToStore);
