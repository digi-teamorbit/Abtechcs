...
class AdminController extends Controller
{
	...
	public function newsletterInquiriesDelete($id) {
		  ...
		  if($del) { 
			  return redirect('admin/newsletter/inquiries')->with('flash_message', 'Newsletter deleted!');
		  }
	...
	public function quoteSubmissions() {
	 	$quote_inquiries = DB::table('quotations')->get();

	 	return view('admin.inquires.quote_inquiries', compact('quote_inquiries'));

	}
	
	public function quoteSubmissionsDelete($id) {

		  $del = DB::table('quotations')->where('id',$id)->delete();
		  
		  if($del) { 
			  return redirect('admin/quote/inquiries')->with('flash_message', 'Quotation deleted!');
		  }
    ...
    public function quoteshow($id)
    {
            ...
            return view('admin.inquires.quote_detail', compact('quote'));
    }
